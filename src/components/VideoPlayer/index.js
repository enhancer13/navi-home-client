...
export default class VideoPlayer extends Component {
  ...
  renderVideo() {
    const { resizeMode, volume, error, paused, muted, rate, fullscreen } =
      this.state;
    const { uri, headers, nativeControls, disableFocus, disposeOnPause } =
      this.props;
    const {
      onLoadStart,
      onProgress,
  ...
  renderScreenTouchHandler(children) {
...
VideoPlayer.propTypes = {
  ...
  hideBottomControlsWhenPaused: PropTypes.bool,
  disposeOnPause: PropTypes.bool,
  startPlaying: PropTypes.bool,
  externalScreenTouchProvider: PropTypes.bool,
};
